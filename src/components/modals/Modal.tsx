...
const Modal = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overscroll-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
